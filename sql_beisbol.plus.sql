...
CREATE DATABASE IF NOT EXISTS cursosenlinea;
USE cursosenlinea;
...
ALTER TABLE `cursosenlinea`.`users` 
ADD COLUMN `last_name` VARCHAR(45) NULL AFTER `updated_at`,
ADD COLUMN `last_name2` VARCHAR(45) NULL AFTER `last_name`,
ADD COLUMN `date_of_birth` DATE NULL AFTER `last_name2`,
ADD COLUMN `phone` VARCHAR(13) NULL AFTER `date_of_birth`,
ADD COLUMN `country` VARCHAR(45) NULL AFTER `phone`,
ADD COLUMN `state` VARCHAR(45) NULL AFTER `country`,
ADD COLUMN `zip_code` VARCHAR(15) NULL AFTER `state`,
ADD COLUMN `ine` VARCHAR(255) NULL AFTER `zip_code`,
ADD COLUMN `proof_of_address` VARCHAR(45) NULL AFTER `ine`,
ADD COLUMN `rfc` VARCHAR(25) NULL AFTER `proof_of_address`;
